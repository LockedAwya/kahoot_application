...
class CreateAnswer3 extends StatefulWidget {
  final String? textanswer;
  final bool isCorrect;
  const CreateAnswer3({Key? key, this.textanswer, this.isCorrect = false})
      : super(key: key);

  @override
  State<CreateAnswer3> createState() => _CreateAnswer3State();
}

class _CreateAnswer3State extends State<CreateAnswer3> {
  bool status = false;
