...
class CreateAnswer1 extends StatefulWidget {
  final String? textanswer;
  final bool isCorrect;
  const CreateAnswer1({Key? key, this.textanswer, this.isCorrect = false})
      : super(key: key);

  @override
  State<CreateAnswer1> createState() => _CreateAnswer1State();
}

class _CreateAnswer1State extends State<CreateAnswer1> {
  bool status = false;
