...
class _CreateAnswer4State extends State<CreateAnswer4> {
  bool status = false;
                ...
                visible: status,
                 child: Align(
                  ...
                  child: Container(
                    ...
                    child: Image.asset('assets/icons/ic_tick.png', width: 20,height: 20,))),
               )
              ],),
            ),
            const SizedBox(
...
class ButtonItem extends StatelessWidget {
  ...
  const ButtonItem({Key? key, required this.colors, required this.text,this.onTap})
      : super(key: key);
